...
function startConsoleTracking(errorObservable) {
    ...
    console.error = internalMonitoring_1.monitor(function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        originalConsoleError.apply(console, params);
        errorObservable.notify(tslib_1.__assign(tslib_1.__assign({}, buildErrorFromParams(params)), { source: error_1.ErrorSource.CONSOLE, startClocks: timeUtils_1.clocksNow(), handling: error_1.ErrorHandling.HANDLED }));
    });
}
